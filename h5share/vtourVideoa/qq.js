function createPanoViewer(e) {
    ...
    function at() {
        ...
        if (f) {
            t = f[z](1)[j]("&");
            for (r = 0; r < t[M]; r++) i = t[r],
                s = i[d]("="),
            s == -1 && (s = i[M]),
                o = i[z](0, s),
                u = ot(o),
                a = i[z](s + 1),
                u == L ? e[L] = a: u == "flash" ? e.flash = a: u == g ? e[g] = a: e.addVariable(o, a)
        }
    }
    function ft(e) {
        return e[P] = at,
        ...
        if (s == 0) {
            ...
            if (e.isDevice("iphone|ipad|ipod") && i[d]("opera mini") < 0) a = f = v;
                ...
                u >= 10.1 && (o = v),
                    ...
                    E = i[d]("firefox/"),
                E < 0 && (E = i[d]("gecko/")),
                E >= 0 && (g = parseInt(i[F](1 + i[d]("/", E)), 10)),
                    h = !!r[tt],
                    E = i[d](tt),
                E > 0 && (b = parseInt(i[F](E + 7), 10), h = v),
                    E = i[d](Z),
                E > 0 && (y = parseInt(i[F](E + 8), 10), g >= 18 && (y = 4)),
                l && (y > 0 && y < 4 && (l = p), g > 3 && g < 18 && y > 1 && (c = l = p), c || (m[d](et) < 0 && g > 3 && y < 1 && (l = p), b > 9 && b < 20 && (l = p)));
                if (l || c) {
                    a = v,
    ...
    e.js || (e.js = w),
    e[q] === undefined && (e[q] = e.swf[j](".swf").join(".xml")),
    ...
    e[O] || (e[O] = {}),
    e[I] || (e[I] = w),
        e[G] ? e[C] = e[G] : (c = "./", h = e.swf[st]("/"), h >= 0 && (c = e.swf[F](0, h + 1)), e[G] = c),
        ...
        e.addVariable = function(t, n) {
            t = ot(t),
                t == "pano" || t == q ? e[q] = n: e[$][t] = n
        },
        e.addParam = function(t, n) {
            e[O][ot(t)] = n
        },
    e[J] !== undefined && (e[L] = e[J]),
        e[J] = function(t) {
            e[L] = t
        },
    ...
    e[S] || (e[S] = function(t) {
        ...
        e.embed = function(c) {
            ...
            c && (e[b] = c),
                e[E] = n[x](e[b]);
            if (!e[E]) e[S]("No Embedding Target");
            else {
                l && at(),
                e[Q] == p && (e[$]["control.disablewheel"] = v),
                e[B] && (e[$][B] = e[B]),
                    lt(),
                    h = ot(e[L]),
                    P = e.flash,
                P && (P = ot(P), P == H ? h = K: P == K ? h = H: P == D ? h = A: P == A && (h = D)),
                    j = o,
                    z = a,
                    J = a,
                J && o && s & 8 && (n.domain == "" || (s & 4) == 0) && (J = p),
                    h == A ? z = p: ut(h, D) && (j = p),
                    ut(h, X) ? (o = j = p, a = z = v) : z && (h == "whenpossible" || ut(h, H) && J || ut(h, "auto") && f) && (j = p);
                if (j && o) {
                    function pt(e) {
                        function N(e) {
                            function a() {
                            ...
                            var i, s = ot(t.appVersion)[d](et) >= 0,
                                o = r._krpMW,
                                u = w;
                        ...
                        e[g] && (h[g] = e[g]),
                        e[T] && (h[T] = e[T]),
                        e[q] !== undefined && (c[q] = e[q]),
                            e[g] = ot(h[g]),
                            h.allowfullscreen = "true",
                            h.allowscriptaccess = X,
                            i = "browser.",
                    ...
                    u >= 11.4 && (G = v, ot(t.platform)[d](et) >= 0 && ot(t.vendor)[d]("apple") >= 0 && (Z = i[d]("webkit/"), Z > 0 && (Z = parseFloat(i[F](Z + 7)), !isNaN(Z) && Z > 0 && Z < 534 && (G = p))), G && e[g] == w && !e[O][g] && (e[g] = s & 8 ? "window": "direct")),
                        pt(e)
                } else if (z && a) {
                    function dt(t) {
                        function i(e, t, r) {
                            ...
                            s && (s = s[0]),
                            s || (s = n.body),
                                s ? (i = n[N]("script"), i.type = "text/javascript", i.async = v, i.onload = t, i[S] = r, i.src = e, s.appendChild(i)) : r()
                        }
                        function s() {
                        ...
                        var r = t.js;
                        r || (r = t.swf, r = r[F](0, r.toLowerCase()[st](".swf") + 1) + "js"),
                            s() ? o() : i(r, o, u)
                    }
                    dt(e)
                } else ft = "",
                    ct = h != A,
                    ht = o == p && (h == A || !ut(h, X) && !ut(h, D)),
